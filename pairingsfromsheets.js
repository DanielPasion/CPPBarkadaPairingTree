...
async function getUbaes(){
    ...
    console.log(initialEdgesUbaes)
    console.log(initialNodesUbaes)
}
...
async function getSiniGangGang(){
    ...
    console.log(initialEdgesSiniGangGang)
    console.log(initialNodesSiniGangGang)
}
...
async function getBasaBuddies(){
    ...
    console.log(initialEdgesBasaBuddies)
    console.log(initialNodesBasaBuddies)
}
...
async function getPakwans(){
    ...
    console.log(initialEdgesPakwans)
    console.log(initialNodesPakwans)
}
...
export {initialNodesUbaes, initialEdgesUbaes, initialNodesSiniGangGang, initialEdgesSiniGangGang, initialNodesPakwans, initialEdgesPakwans, initialNodesBasaBuddies, initialEdgesBasaBuddies}